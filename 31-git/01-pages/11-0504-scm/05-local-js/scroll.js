...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('#rev-scroll').append (
        "<p>000.106</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
   $('.js--sc-050400').click(function () {
      $('html, body').animate({scrollTop: $('#js--050400').offset().top -20}, 1000);
   });

   $('.js--sc-050401').click(function () {
      $('html, body').animate({scrollTop: $('#js--050401').offset().top -20}, 1000);
   });
   $('.js--sc-050402').click(function () {
      $('html, body').animate({scrollTop: $('#js--050402').offset().top -20}, 1000);
   });
   $('.js--sc-050403').click(function () {
      $('html, body').animate({scrollTop: $('#js--050403').offset().top -20}, 1000);
   });
