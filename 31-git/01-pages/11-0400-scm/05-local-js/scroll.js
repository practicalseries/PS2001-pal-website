...
-------------------------------------------------------------------------------
09 Apr 2021   000.105      M. Gledhill    Scroll points added for page
...
/* ****************************************************************************
   ...
   **************************************************************************** */
    ...
    $('#rev-scroll').append (
        "<p>000.105</p>" /* LOCAL JS REVISION NUMBER */
    );
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-040000').click(function () {
       $('html, body').animate({scrollTop: $('#js--040000').offset().top -10}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
   $('.js--sc-040100').click(function () {
      $('html, body').animate({scrollTop: $('#js--040100').offset().top -20}, 1000);
   });

   $('.js--sc-040200').click(function () {
      $('html, body').animate({scrollTop: $('#js--040200').offset().top -20}, 1000);
   });

   $('.js--sc-040300').click(function () {
      $('html, body').animate({scrollTop: $('#js--040300').offset().top -20}, 1000);
   });

   $('.js--sc-040400').click(function () {
      $('html, body').animate({scrollTop: $('#js--040400').offset().top -20}, 1000);
   });

   $('.js--sc-040500').click(function () {
      $('html, body').animate({scrollTop: $('#js--040500').offset().top -20}, 1000);
   });

   $('.js--sc-040600').click(function () {
      $('html, body').animate({scrollTop: $('#js--040600').offset().top -20}, 1000);
   });

   $('.js--sc-040601').click(function () {
      $('html, body').animate({scrollTop: $('#js--040601').offset().top -20}, 1000);
   });
...
/* ---------------------------------------------------------------------------
   ...
   $('.js--sc-f04-01').click(function () {
      $('html, body').animate({scrollTop: $('#js--f04-01').offset().top -80}, 1000);
   });
   $('.js--sc-f04-02').click(function () {
      $('html, body').animate({scrollTop: $('#js--f04-02').offset().top -80}, 1000);
   });
   $('.js--sc-f04-03').click(function () {
      $('html, body').animate({scrollTop: $('#js--f04-03').offset().top -80}, 1000);
   });
   $('.js--sc-f04-04').click(function () {
      $('html, body').animate({scrollTop: $('#js--f04-04').offset().top -80}, 1000);
   });

   $('.js--sc-t04-01').click(function () {
      $('html, body').animate({scrollTop: $('#js--t04-01').offset().top -60}, 1000);
   });
   $('.js--sc-t04-02').click(function () {
      $('html, body').animate({scrollTop: $('#js--t04-02').offset().top -60}, 1000);
   });
   $('.js--sc-t04-03').click(function () {
      $('html, body').animate({scrollTop: $('#js--t04-03').offset().top -60}, 1000);
   });
   $('.js--sc-t04-04').click(function () {
      $('html, body').animate({scrollTop: $('#js--t04-04').offset().top -60}, 1000);
   });

   $('.js--sc-c04-01').click(function () {
      $('html, body').animate({scrollTop: $('#js--c04-01').offset().top -120}, 1000);
   });
   $('.js--sc-c04-02').click(function () {
      $('html, body').animate({scrollTop: $('#js--c04-02').offset().top -120}, 1000);
   });
   $('.js--sc-c04-03').click(function () {
      $('html, body').animate({scrollTop: $('#js--c04-03').offset().top -120}, 1000);
   });
   $('.js--sc-c04-04').click(function () {
      $('html, body').animate({scrollTop: $('#js--c04-04').offset().top -120}, 1000);
   });
