...
*******************************************************************************
Title :          PRACTICAL SERIES                               RUN-PRETTIFT.JS
*******************************************************************************
...
This is the google-prettify Java Script file.

This version utilises a remote copy of the css and language files. These are 
loaded from the web server.

To accomodate this,the LOADER_BASE_URL has been set to a local value:

LOADER_BASE_URL = 
'https://practicalseries.com/2001-pal/00-comres/21-global/05-js/google-prettify'




*******************************************************************************
PRACTICAL SERIES - MODIFICATION HISTORY:
...
09 Feb 2021   W00.000      M. Gledhill    Revision data added for PAL
                                          Note:  W denotes web based files, 
                                                 L denotes local files
---------------------------------------------------------------------------- */
...
/* ****************************************************************************
   REVISION - Practical Series Revision Data
   ************************************************************************* */
$(document).ready(function() {                      /* START OF PAGE READY FUNCTION */

    $('#rev-run-prettify').append (
        "<p>W01 \u00A0\u00A0\u00A0</p>"             /* LOCAL JS REVISION NUMBER */
    );
