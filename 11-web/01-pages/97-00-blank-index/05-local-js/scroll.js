...
08 Feb 2021   000.001      M. Gledhill    Baseline page configured for PAL
                                          Utilises 00-comres folder

05 Feb 2021   000.000      M. Gledhill    Established for PAL
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-000100').click(function () {
       $('html, body').animate({scrollTop: $('#js--000100').offset().top -10}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-970100').click(function () {
       $('html, body').animate({scrollTop: $('#js--970100').offset().top -20}, 1000);
    });

    $('.js--sc-970101').click(function () {
       $('html, body').animate({scrollTop: $('#js--970101').offset().top -20}, 1000);
    });
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
          $('.js--sc-970101a').click(function () {
           $('html, body').animate({scrollTop: $('#js--970101a').offset().top -120}, 1000);
          });

           $('.js--sc-970101b').click(function () {
           $('html, body').animate({scrollTop: $('#js--970101b').offset().top -120}, 1000);
          });
